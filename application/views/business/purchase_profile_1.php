            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card direct-chat direct-chat-warning">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form class="form-horizontal form-label-left" method="post" id="update_order_form" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="transaction_type_id" value="2" readonly required style="visibility: hidded; display: none;" />
                                    ...
                                    <div class="row" style="border-top: 1px solid #DDDDDD; margin-top: 30px;">
                                        ...
                                        <br> -->
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" readonly name="total" id="itemstotal" class="money form-control" style="width: 90%;" value="<?php echo $net_amount; ?>" />
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <select class="form-control" name="payment_mode_id" style="width: 90%;" required>
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $pm->payment_mode_id; ?>" <?php if ($pm->payment_mode_id == $payment_mode_id) echo "selected"; ?>> <?php echo $pm->payment_mode_name; ?> </option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                ...
                                                <br>
                                                <div class="row">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Balance/Debt Status: </label>
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <span style="padding-left: 10px;">
                                                            <?php
                                                            if ($paying_balance == 0) echo '<button class="btn btn-success" disabled>Settled <span class="fa fa-check"></span></button>';
                                                            else echo '<button class="btn btn-warning" disabled>Unsettled <span class="fa fa-cross"></span></button>';
                                                            ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="number" name="paid_amount" id="paid_amount" onkeyup="get_change_return(this)" class="money form-control" value="<?php echo $paid_amount; ?>" style="width: 90%; background-color: #1ABB9C; color: #fff;" required />
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="number" readonly name="paying_balance" id="paying_balance" class="money form-control" value="<?php echo $paying_balance; ?>" style="width: 90%;">
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="number" readonly name="change_return" id="change_return" class="money form-control" value="<?php echo $change_return; ?>" style="width: 90%; background-color: #E6A56C;">
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row">
                                                    <p style="padding-right: 30px" id="action_buttons">
                                                        <input type="button" class="btn btn-danger pull-right" onclick="window.open('<?php echo site_url('business/purchase_receipt/' . $order_id); ?>','receipt','width=400, height=800')" value="Print Receipt" />
                                                        <input type="submit" class="btn btn-primary pull-right" id="submit" value="Update" />
                                                    </p>
                                                </div>
                                ...
                                <form action="<?php echo site_url('business/new_order_payment/' . $order_id); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-6">
                                            ...
                                            <select class="select2 form-control" name="payment_mode_id" onchange="get_more(this)" style="width: 90%;" required>
                                                <option value=""> Select payment mode </option>
                                                <?php
                                                foreach ($payment_modes as $pm) {
                                                ?>
                                    ...
                                    <div class="row" id="ttype-3" style="display: none;">
                                        <!-- Mpesa Transaction -->
                                        <div class="col-md-4 col-xs-6">
                                    ...
                                    <div class="row" id="ttype-1" style="display: none;">
                                        <!-- Bank Transaction -->
                                        <div class="col-md-4 col-xs-6">
                                    ...
                                    <div class="col-md-12 col-xs-12" style="padding-top: 10px;">
                                        <button type="submit" name="Pay" class="btn btn-success pull-right" style=" margin-right: 40px;">Pay <span class="fa fa-money"></span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" id="order_table">
                                            ...
                                            ?>
                                                <tr>
                                                    <td> <?php echo $op->payment_amount; ?> </td>
                                                    <td> <?php echo $op->payment_mode_name; ?> </td>
                                                    <td> <?php echo $op->payment_date; ?> </td>
                                                    <td> <?php echo $op->transaction_code; ?> </td>
                                                    <td> <?php echo $op->bank_account_number; ?> </td>
                                                    <td> <?php echo $op->check_number; ?> </td>
                                                    <td> <?php echo $op->check_maturity_date; ?> </td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
