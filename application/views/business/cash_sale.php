                            ...
                            <form class="form-horizontal form-label-left" id="place_order_form" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="transaction_type_id" value="1" readonly required style="visibility: hidded; display: none;" /> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="order_table">
                                            ...
                                            <tr id="row1">
                                                ...
                                                <td><input type="number" class="form-control" onchange="qty(1)" name="qty[]" id="qty_1" value='1' placeholder="Enter Qty" /></td>
                                                <td>
                                                    <input type="text" class="form-control" onkeyup="set_amount(1)" name="rate[]" id="rate_1" />
                                                    <input type="text" class="form-control" id="rateb_1" readonly style="display: none; visibility: hidden;" />
                                                </td>
                                                <td><input type="text" class="form-control" readonly name="tax[]" id="tax_1" /></td>
                                                <td><input type="text" class="form-control" readonly name="amount[]" id="amount_1" /></td>
                                                <td><button class="btn btn-default" onclick="delete_row(1)"><span class="fa fa-close"></span></button></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="row">
