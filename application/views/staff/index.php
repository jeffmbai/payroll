    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <?php if ($CI->permissions('staff_add')) : ?>
                                ...
                                <form action="<?php echo site_url('staff/add_staff'); ?>" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6">
                                            ...
                                            <input type="" class="form-control" name="primary_phone" required />
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            ...
                                            <p>
                                                Male:<input type="radio" class="flat" name="gender" id="yes" value="M" required />
                                                Female:<input type="radio" class="flat" name="gender" id="no" value="F" required />
                                            </p>
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            ...
                                            <p>
                                                Yes:<input type="radio" class="flat" name="disability" id="yes" value="1" />
                                                No:<input type="radio" class="flat" name="disability" id="no" value="0" />
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="employment_number" />
                                        </div>
                                        <div class="col-md-3 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <input type="number" class="form-control" step="0.01" name="paye" required />
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <label>NSSF Amount <i class="text-danger">*</i></label>
                                            <input type="number" class="form-control" step="0.01" name="nssf_amount" required />
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <label>NHIF Amount <i class="text-danger">*</i></label>
                                            <input type="number" class="form-control" step="0.01" name="nhif_amount" required />
                                        </div>
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <label>Tax Relief <i class="text-danger">*</i></label>
                                            <input type="number" class="form-control" step="0.01" name="tax_relief_amount" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <input type="number" class="form-control" step="0.01" name="insurance_relief_amount" required />
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <label for="">Narrative </label>
                                            <textarea class="form-control" name="narrative" placeholder="Type here..."></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <?php if ($CI->permissions('archivestaff_view')) : ?>
                                        <a href="<?php echo site_url('staff/archive_staff'); ?>" class="btn btn-primary pull-right">Archived Staff <i class="fa fa-random"></i></a>
                                    <?php endif; ?>
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i> </button>
                                    <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i></button>
                                </div>
