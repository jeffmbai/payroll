          ...
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <!-- <img src="<?php echo base_url();?>/assets/POS-JiPOS-logo.png" alt="logo" class="logo"> -->
                <?php
              ...
              <form action="<?php echo site_url('user/signin_auth');?>" method="post">
                ...
                <nav class="login-card-footer-nav">
                  ...
                  <span class="float-right" style="color: #919aa3"> &copy; <?php echo date('Y');?> By <a href="http://jiwanitech.com" target="_blank" >JiPOS</a> </span>
                </nav>
            </div>
          </div>
        </div>
