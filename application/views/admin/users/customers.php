                        ...
                        <div class="card card-outline card-warning">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button class="btn btn-xs btn-info pull-right" data-toggle="modal" data-target="#addCustomer">New Customer</button>
...
<div class="modal fade" id="addCustomer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="<?php echo site_url('users/add_supplier_customer/4'); ?>" method="post">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-6">
                                <label for="">First Name <span class="text text-danger">*</span> </label>
