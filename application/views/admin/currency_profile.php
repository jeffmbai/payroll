...
foreach ($this_currency as $sarafu) {
    $currency_id = $sarafu->currency_id;
    $currency_code = $sarafu->currency_code;
    $active = $sarafu->active;
    $narrative = $sarafu->narrative;
}
?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 table-repsonsive">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="rm_border_top pd_right"><b>Currency code</b></td>
                ...
                <?php if ($CI->permissions('general_view')) : ?>
                    <div class="col-md-7 col-sm-12">
                        <div class="card card-outline card-warning">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?php echo site_url('submitform/update_currency/' . $currency_id); ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="">Currency Code <span class="text text-danger">*</span> </label>
                                            <input type="text" name="currency_code" class="form-control" value="<?php echo $currency_code; ?>" required />
                                        </div>
                                        <div class="col-md-3">
                                            <label> Active </label>
                                            <p>
