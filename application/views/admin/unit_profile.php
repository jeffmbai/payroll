    ...
    <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <a href="<?php echo site_url('sys/units');?>" class="btn btn-primary btn-xs">See units </a>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="table-repsonsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="rm_border_top pd_right"><b>Unit Name</b></td>
        ...
        <div class="col-md-5 col-sm-5 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_content">
                    <div class="row">
                    <form action="<?php echo site_url('submitform/update_unit/'.$unit_id);?>" method="post">
                        <div class="col-md-12">
                            <label for="">Unit Name <span class="text text-danger">*</span> </label>
                            <input type="text" name="unit_name" class="form-control" value="<?php echo $name;?>" required />
                        </div>
                        <div class="col-md-3">
                            <label> Active </label>
                            <p>
